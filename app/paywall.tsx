...
const FEATURES = [
  {
    ...
    description: "Log feeds, sleep, diapers, and milestones without limits",
  },
  {
    icon: "📊",
    title: "Detailed Insights",
    description: "Charts and trends to understand your baby's patterns",
  },
  {
    icon: "🤱",
    title: "Expert Guidance",
    description: "Personalized tips and advice for every stage",
  },
  {
    icon: "💛",
    title: "Family Sharing",
    description: "Share progress with your partner and caregivers",
  },
];
            ...
            {isWeb ? (
              <>
                ...
                <Text style={styles.legalText}>
                  ...
                  <Text
                    style={styles.legalLink}
                    onPress={() => Linking.openURL("https://nirvanadsouza24-blip.github.io/Mama-Meadow/terms.html")}
                  >
                    Terms of Use
                  </Text>
                </Text>
